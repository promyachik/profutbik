...
<style>
  ...
  /* PF521A: панель живёт один просмотр страницы, поэтому «убрать» здесь
     означает просто убрать — обновление и так всё вернёт к чистому виду.
     Точки при этом остаются: они в отдельном ключе и вернутся, когда панель
     вызовут снова. */
  button("Убрать панель", () => {
  ...
  paint();
  hint("Точки включены на этот просмотр. Обновишь — исчезнут");
})();

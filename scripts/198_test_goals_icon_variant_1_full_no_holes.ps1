...
Write-Host ""
Write-Host "PROFUTBIK 198 - test goals icon variant 1 full no holes"
Write-Host "Project: $project"
Write-Host ("Time: " + (Get-Date -Format "yyyy-MM-dd HH:mm:ss"))
Write-Host ""

$targetPng = Join-Path $project "static\images\stats-icons-v184\goals.png"
$sourcePng = Join-Path $project "payload\198\goals_variant_1_full_no_holes.png"
$partial = Join-Path $project "layouts\partials\transfer-player-stats.html"
$backupDir = Join-Path $project "_backup_198_test_goals_icon_variant_1_full_no_holes"
...
$backupPng = Join-Path $backupDir "goals_before_198.png"
$backupPartial = Join-Path $backupDir "transfer-player-stats_before_198.html"

if (!(Test-Path $backupPng)) {
    Copy-Item $targetPng $backupPng -Force
    Write-Host "Backup saved: _backup_198_test_goals_icon_variant_1_full_no_holes\goals_before_198.png"
}

if (!(Test-Path $backupPartial)) {
    Copy-Item $partial $backupPartial -Force
    Write-Host "Backup saved: _backup_198_test_goals_icon_variant_1_full_no_holes\transfer-player-stats_before_198.html"
}

Copy-Item $sourcePng $targetPng -Force
Write-Host "Copied TEST variant 1 full/no-holes to: static\images\stats-icons-v184\goals.png"
...
$html = [regex]::Replace(
    ...
    'goals.png" | relURL }}?v=198'
)

$marker = "/* 198 test goals icon variant 1 full no holes */"
$css = @"
...
Write-Host "Patched cache/CSS to v198: layouts\partials\transfer-player-stats.html"
Write-Host ""
